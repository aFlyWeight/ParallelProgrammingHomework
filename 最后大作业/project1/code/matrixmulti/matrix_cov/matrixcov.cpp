...
//        matgenetest(B, kernelsize,kernelsize);
        matgene(A, matsize, matsize);
        matgene(B, kernelsize,kernelsize);
        elapsed_time = -MPI_Wtime();
        matcov(A, B, C, matsize, kernelsize, outmatsize);
        elapsed_time += MPI_Wtime();
...
//           matgenetest(B, kernelsize, kernelsize);
        ...
        free(partitionA);
        matcov(partA, B,partC, (part_matsize + adjustsize), kernelsize, part_poolingsize);
        /*
